        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #5a08dd;">Welcome to AI&DEV</h1>
                    <p class="mb-4">
                        At AI&DEV, we believe in accessible, innovative learning experiences that adapt to your
                    ...
                    <p class="mb-4">Welcome to AI&DEV, where learning knows no boundaries. Our mission
                        is to empower individuals worldwide through accessible and innovative education. Here's what
                        sets us apart:</p>

                    <h3 class="mb-4">Our Vision</h3>
                    <p class="mb-4">At AI&DEV Space, we envision a world where learning is accessible to everyone,
                    ...
                    <p class="mb-4">We believe in the transformative power of education. AI&DIV Space is
                    ...
                    <p class="mb-4"> AI&DEV Space contains more than just courses; it's a vibrant community. We
                    ...
                    <p class=" mt-5 mb-4">Thank you! for being a part of AI&DEV. Together, let's embark on a
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+xxxxxxx</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>xxxxxxx@gmail.com</p>
