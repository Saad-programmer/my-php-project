<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Validate required fields
            ...
            $query = "INSERT INTO events_att (name, email, phone, gender, dob, level) 
                      VALUES ('$name', '$email', '$phone', '$gender', '$dob', '$level')";
                ...
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15">Take a seat</span>
                            <form id="stripe-signup" method="POST" action="signup.php">
                                ...
                                <div class="field padding-bottom--24">
                                    <input type="submit" name="submit" value="Take Seat Now" placeholder="Take a seat">
                                </div>
                            </form>
                        </div>
                    </div>
