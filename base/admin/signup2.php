<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Validate required fields
            ...
            $query = "INSERT INTO n_users (name, email, phone, gender, dob, level, password,subjects) 
                      VALUES ('$name', '$email', '$phone', '$gender', '$dob', '$level', '$password','$subjects')";
        ...
        <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh; flex-grow: 1;">
            ...
            <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
                <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
                    <h1><a href="../../index.php" rel="dofollow">AI&DEV Space</a></h1>
                </div>
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15">Create a New Account</span>
                            <form id="stripe-signup" method="POST" action="signup.php">
                                ...
                                <div class="field padding-bottom--24">
                                    ...
                                    <input type="text" name="level" placeholder="S1,S3,S5 - Field" required>
                                </div>
                                <div class="input_wrap">
                                    <label for="subjects">Courses</label>
                                    <select name="subjects" id="subjects" required>
                                        <option value="">Select course needed</option>
                                        <option value="AI">AI</option>
                                        <option value="WebDevelopment">Web Development</option>
                                        <option value="Cybersecurity">Cyber Sécurité</option>
                                        <option value="Programmation">Programmation</option>
                                        <option value="Projects">Project Live</option>
                    ...
                    <div class="footer-link padding-top--24">
                        <span>Already have an account? <a href="../../man/login.php">Login</a></span>
                    </div>
                </div>
            </div>
        </div>
