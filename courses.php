    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5" style="color: rgba(0, 0, 255, 0.5);">Popular Topics to Explore</h1>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5" style="color: rgba(0, 0, 255, 0.5);">Explore new and trending free online courses</h1>
            </div>
