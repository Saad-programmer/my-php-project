...
<head>
    ...
    <title>AI & DEV SPace - owner</title>
</head>
<body>
    <div class="header">
    ...
    <div class="main">
        <div class="card1">
            <div class="card" style="width: 18rem;">
             ...
             <div class="card-body">
                <?php
                echo "<h5 class='card-title'>Total Members: ".$row['total_rows']."</h5>
               <p class='card-text'>Some quick example text to build on the card title and make up the bulk of the card's content.</p>
               <a href='teacher-list.php' class='btn btn-primary'>See Members List</a>";
               }
               ?>
             </div>
           </div>
    ...
    ?>
        <div class="card2">
            <div class="card" style="width: 18rem;">
             ...
             <div class="card-body">
               <h5 class="card-title">Total Users: <?php echo $rows['total_row'];} ?></h5>
               <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
               <a href="student-list.php" class="btn btn-primary">See Users List</a>
             </div>
           </div>
        </div>
    </div>
