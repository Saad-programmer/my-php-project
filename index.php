...
$sql = "SELECT event_name, event_date, event_time, event_image FROM events";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <p class="m-0 fw-bold" style="font-size: 25px;"><img src="img/icon.png" alt="" height="200px">AI&<span
                    style="color: #5a08dd;">DEV Community</span></p>
        </a>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class=" text-uppercase mb-3 animated slideInDown" style="color: #5a08dd;">
                                    E-learning platform from AI&DEV</h5>
                                <h1 class="display-3 text-white animated slideInDown">Learn Job ready skills from our
                                     courses and formations with certificates</h1>
                                ...
                                <a href="about.php"
                                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft" color="blue">Read More</a>
                                <a href="./man/login.php" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join
                                    Now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class=" text-uppercase mb-3 animated slideInDown" style="color: #5a08dd;">Welcome to
                                    AI&DEV</h5>
                                <h1 class="display-3 text-white animated slideInDown">Be a Part Of OUR Community
                                </h1>
                                <p class=" text-white mb-4 pb-2">Engage with interactive activities, workshops, and
    ...
    <div class="owl-carousel header-carousel position-relative">
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="upload/event.png" alt="Event Image">
                            ...
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    ...
                                    <h1 class="display-3 text-white animated slideInDown">
                                        <?php echo date('F j, Y', strtotime($row['event_date'])); ?> at <?php echo date('H:i', strtotime($row['event_time'])); ?>
                                    </h1>
                                    <p class="text-white mb-4 pb-2">Join us for an unforgettable event experience!</p>
                                    <a href="single.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="text-center text-white">No events available at the moment.</p>
        <?php endif; ?>
    </div>
</div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #5a08dd;">Welcome to AI&DEV Space</h1>
                    <p class="mb-4">At AI&DEV, we believe in accessible, innovative learning experiences that
                    ...
                    <p class="mb-4"> Welcom to AI&DEV Space, your gateway to boundless learning opportunities. We're
        ...
        <div class="container">
            <div class="row g-5 ">
                <div class="col-lg-6 p-5 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #5a08dd;">Explore Free Courses</h1>
                    ...
                    <a class="btn text-light py-3 px-5 mt-2" href="man/login.php">Start For Free</a>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/photo-1.jpg" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5" style="color: #5a08dd;">Popular Topics to Explore</h1>
            </div>
            <div class="row g-2 m-2">
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">Microsoft Excel</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center"> AWS</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">Python</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">Java</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">Web Design</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">Web Development</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">MySQL</a>
                        </h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6  text-center">
                    <div class="content shadow p-3 mb-2 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h5 class="my-2">
                            <a href="./base/admin/signup2.php" class="text-center">UI/UX Design</a>
                        </h5>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5" style="color: #5a08dd;">Explore new and trending free online courses</h1>
            </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item shadow">
                        <div class="position-relative overflow-hidden text-light image">
                            ...
                            <div style="position:absolute;top: 15px;left: 16px; font-size:12px; border-radius:3px; background-color:#5a08dd;"
                                class="px-2 py-1 fw-bold text-uppercase">FREE</div>

                        </div>
                        <div class="p-2 pb-0">

                            <h5 class="mb-1"><a href="./base/admin/signup2.php" class="text-dark">HTML Course for Beginners </a></h5>
                        </div>
                        <div class="d-flex">
                        ...
                        <div class="d-flex">
                            ...
                            <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="/man/login.php">Enroll
        ...
        <div class="container-xxl mt-5" >
            <div class="container" >
                <div class="row g-5 ">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100 bg-light" src="img/capture21.png" alt=""
                                style="object-fit: cover;">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 p-5 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h1 class="mb-4" style="color: #5a08dd;">Become a member</h1>
                        <p class="mb-4 text-white">Members from our the community learn many subjects. We provide
                            the tools and skills to teach what you love.</p>
    
                        <a class="btn text-light py-3 mt-2" href="instructor.php">Start The Journey Today</a>
                    </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                          ...
                          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                You can simultaneously enroll in multiple courses at AI&DEV.
                            </div>
                          </div>
                        </div>
                        <div class="accordion-item">
                          ...
                          <div class="accordion-item">
                            <h2 class="accordion-header">
                              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                What are the most popular free courses offered by AI&DEV ?
                              </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                              <div class="accordion-body">
                                ...
                                <p>Some of the most popular free courses offered by AI&DEV that are in high demand today include:</p>
                                <ul>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Faculty Of Science BenMSICK</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+xxxxxxxx</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>xxxxxxxx@gmail.com</p>
