...
<head>
    <meta charset="utf-8">
    <title>AI&DEV : Testimonial</title>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                ...
                <p class="mb-5">Can AI&DEV courses help your career? Our learners tell us how.</p>
            </div>
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    ...
                    <div class="testimonial-text bg-light text-center p-4">
                        <p class="mb-0">I stumbled upon AI&DEV while searching for free courses. The quality
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+xxxxxxxxxxxxx</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>xxxxxxxxxxx@gmail.com</p>
